        ...
        <div class="row">
            ...
            <div id="over-review" class="col-12">
                ...
                <div class="mb-3 col-12">
                    ...
                    <textarea type="text" class="form-control" style="height: 200px;" id="noidung" name="category_des" value="{{old('category_des')}}"></textarea>
                    @error('category_des')
                        <span class="mt-2 d-block" style="color: red;">{{$message}}</span>
                    @enderror
                </div>
            ...
            <div id="data-category" class="col-12 d-none">
                ...
                <div class="mb-3 col-12">
                    ...
                    <textarea type="text" class="form-control" style="height: 200px;" id="noidung1" name="category_des_cre" value="{{old('category_des_cre')}}"></textarea>
